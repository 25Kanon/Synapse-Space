    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="container max-w-4xl p-6 bg-white shadow-md rounded-lg overflow-y-auto h-[80vh]">
                ...
                <h2 className="mt-6 font-semibold">3. Data Protection and Security</h2>
                <p className="text-justify">
                ...
                <h2 className="mt-6 font-semibold">4. Google Account Login</h2>
                <p className="text-justify">
                ...
                <h2 className="mt-6 font-semibold">5. Children’s Privacy</h2>
                <p className="text-justify">
                ...
                <h2 className="mt-6 font-semibold">6. Cookies and Tracking</h2>
                <p className="text-justify">
                ...
                <h2 className="mt-6 font-semibold">9. How to Contact Us</h2>
                <p className="text-justify">
                ...
                <h2 className="mt-6 font-semibold">10. Changes to This Privacy Policy</h2>
                <p className="text-justify">
