...
const FriendsList = () => {
  return (
    <aside id="sidebar" className="fixed top-0 right-0 z-40 w-64 pt-20 transition-transform -translate-x-full sm:translate-x-0 sm:block hidden" style={{ height: '95%' }} aria-label="Sidebar">
