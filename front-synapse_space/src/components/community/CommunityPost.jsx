            ...
            <div key={postId} className={`w-full my-5 border border-solid shadow-xl card card-compact ${isPinned ? 'border-amber-400' : ''}`}>
                    ...
                    <div className="flex items-center h-5">
                        ...
                        <div className="mx-2">
                            <div className="dropdown dropdown-end">
                                ...
                                <ul tabIndex={0} className="p-2 shadow menu dropdown-content bg-secondary rounded-box w-52">
                ...
                <div className="flex flex-row m-4 -gap-4">
                    <FormControlLabel
                        name="likeBtn"
                        value={likes.length}
                        control={<Checkbox onChange={handleLikeChange} checked={isLiked} {...label} icon={<FontAwesomeIcon className="text-xl text-current text-secondary dark:text-neutral-300" icon={faThumbsUp} />} checkedIcon={<FontAwesomeIcon className="text-xl" icon={ThumbsUpIcon} />} />}
                        label={likes.length}
                        labelPlacement="end"
                    />
