...
const CommunityCard = ({ community, getInitials, isJoined }) => {
  ...
  return (
      <div className="p-4 w-full sm:w-1/2 lg:w-1/3 xl:w-1/4">
        <div
            className="transition-transform transform shadow-lg cursor-pointer card bg-base-100 hover:scale-105 hover:shadow-xl h-full flex flex-col"
        ...
        >
          ...
          <div className="card-body flex flex-col flex-grow p-4">
            ...
            <p className="mt-2 text-xs text-gray-400">
              {community.name} members • {community.date}
            </p>
